...
The algorithm is a top down recursive parser with some extra bells and whistles that are described below. It is not not Left Recursive, so write your parser rules accordingly.
